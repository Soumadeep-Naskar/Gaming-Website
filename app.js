...
const change_img_data = ()=>{
  ...
  setTimeout(() => {
    img_change.style.background = "url('cards/acvv.avif') no-repeat center center/cover"
  }, 3000);
  setTimeout(() => {
    img_change.style.background = "url('cards/assasins.jpg') no-repeat center center/cover"
  }, 6000);
}
