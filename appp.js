...
const change_img_data = ()=>{
  setTimeout(() => {
    img_change.style.background = "url('cards/exp1.jpg') no-repeat center center/cover"
  }, 0000);
  setTimeout(() => {
    img_change.style.background = "url('cards/exp2.jpg') no-repeat center center/cover"
  }, 3000);
  setTimeout(() => {
    img_change.style.background = "url('cards/exp3.jpg') no-repeat center center/cover"
  }, 6000);
}
...
// Clear search on blur (optional: reset results too)
searchInput.addEventListener("blur", () => {
    searchInput.value = "";
    allCards.forEach(card => card.style.display = "flex"); // or "block"
